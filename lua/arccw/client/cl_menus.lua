...
function ArcCW_Options_Client( CPanel )
    ...
    CPanel:AddControl("Checkbox", {Label = "#arccw.cvar.altlaserkey", Command = "arccw_altlaserkey" })
...
function ArcCW_Options_Server( CPanel )
    ...
    CPanel:AddControl("Checkbox", {Label = "#arccw.cvar.override_barrellength", Command = "arccw_override_nearwall" })
end
