...
function ArcCW_Options_Atts( CPanel )
    ...
    CPanel:AddControl("Header", {Description = "0 = Don't lose; 1 = Removed, 2 = Drop Attachment Box"})
    CPanel:AddControl("Slider", {Label = "Lose Attachments Type", Command = "arccw_attinv_loseondie", Min = 0, Max = 2, Type = "int" })
