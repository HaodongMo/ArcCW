...
function ArcCW_Options_Client( CPanel )
    ...
    CPanel:AddControl("Checkbox", {Label = "E+R To Toggle firemode (Disables +ZOOM)", Command = "arccw_altfcgkey" })
    CPanel:AddControl("Checkbox", {Label = "E+RMB To Toggle UBGL (Disables 2x +ZOOM)", Command = "arccw_altubglkey" })
    ...
    CPanel:AddControl("Checkbox", {Label = "Aim Blur", Command = "arccw_blur_toytown" })
    ...
    CPanel:AddControl("Slider", {Label = "Case Lifetime", Command = "arccw_shelltime", Min = 0, Max = 180, Type = "float" })
    CPanel:AddControl("Checkbox", {Label = "Custom Swaying", Command = "arccw_vm_coolsway" })
    CPanel:AddControl("Checkbox", {Label = "Custom Camera Movement", Command = "arccw_vm_coolview" })
    ...
    CPanel:AddControl("Slider", {Label = "Camera Movement Multiplier", Command = "arccw_vm_coolview_mult", Min = -10, Max = 10, Type = "float" })
end
...
function ArcCW_Options_Atts( CPanel )
    ...
    CPanel:AddControl("Slider", {Label = "Pick X", Command = "arccw_atts_pickx", Min = 0, Max = 10, Type = "int" })
...
function ArcCW_Options_Server( CPanel )
    ...
    CPanel:AddControl("Checkbox", {Label = "Grenade Inherit Velocity", Command = "arccw_throwinertia" })
    CPanel:AddControl("Header", {Description = ""})
